...
|---|---|---|
| Default direct product spec plus optional user-merged spec PR | Implemented, uncommitted | `spec_pr_merge_mode`, `publish-spec`, `spec_merge`, exact Card record |
...
| Default automatic merge plus optional user merge | Implemented, uncommitted | `code_pr_merge_mode`, `manual_merge` gate, confirmed-merge reconciliation |
